...
This project can be used as starting point to build the authentication for an API or a full stack app. It is not perfect but is solid base, and I think it can be useful to many developers who doesn't know where to start.
